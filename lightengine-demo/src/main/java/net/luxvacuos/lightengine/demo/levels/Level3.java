...
public class Level3 extends AbstractState {
	...
	public void start() {
		...
		TaskManager.addTask(() -> {
			//Light light4 = new Light(new Vector3f(0, 18, 0), new Vector3f(500, 500, 500), new Vector3f(-90, 0, 0), 60,
			//		55);
		...
		RenderEntity scene = new RenderEntity("", "levels/level3/level.blend");
