...
import net.luxvacuos.lightengine.client.rendering.api.opengl.shaders.data.UniformInteger;
import net.luxvacuos.lightengine.client.rendering.api.opengl.shaders.data.UniformLight;
