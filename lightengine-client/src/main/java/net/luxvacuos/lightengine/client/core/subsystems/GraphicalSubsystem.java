...
import static org.lwjgl.opengles.GLES20.GL_RENDERER;
...
import net.luxvacuos.lightengine.client.rendering.api.opengles.GLUtil;
...
import net.luxvacuos.lightengine.client.rendering.api.opengles.objects.DefaultData;
import net.luxvacuos.lightengine.client.rendering.api.opengles.shaders.ShaderIncludes;
...
public class GraphicalSubsystem implements ISubsystem {
	...
	public void init() {
		...
		ShaderIncludes.processIncludeFile("global.isl");
		GLUtil.init();
