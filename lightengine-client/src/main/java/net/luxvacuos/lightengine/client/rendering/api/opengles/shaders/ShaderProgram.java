...
import static org.lwjgl.opengles.GLES20.glValidateProgram;
...
import net.luxvacuos.lightengine.client.rendering.api.opengles.shaders.data.IUniform;
...
public abstract class ShaderProgram implements IDisposable {
	...
	private static boolean GLES = true;
