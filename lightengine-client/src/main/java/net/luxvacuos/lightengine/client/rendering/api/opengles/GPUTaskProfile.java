...
import static org.lwjgl.opengles.EXTDisjointTimerQuery.glGetQueryObjectui64EXT;
...
import static org.lwjgl.opengles.GLES30.glGetQueryObjectui;
...
public class GPUTaskProfile implements Poolable {
	...
	public long getStartTime() {
		return glGetQueryObjectui64EXT(startQuery, GL_QUERY_RESULT);
	}

	public long getEndTime() {
		return glGetQueryObjectui64EXT(endQuery, GL_QUERY_RESULT);
	}
