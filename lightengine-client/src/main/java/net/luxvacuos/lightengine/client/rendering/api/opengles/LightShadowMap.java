...
import static org.lwjgl.opengles.GLES20.glTexParameterfv;
import static org.lwjgl.opengles.GLES20.glTexParameteri;
import static org.lwjgl.opengles.GLES20.glViewport;
import static org.lwjgl.opengles.GLES30.GL_COMPARE_REF_TO_TEXTURE;
import static org.lwjgl.opengles.GLES30.GL_TEXTURE_COMPARE_MODE;
import static org.lwjgl.opengles.GLES32.GL_CLAMP_TO_BORDER;
import static org.lwjgl.opengles.GLES32.GL_TEXTURE_BORDER_COLOR;
...
public class LightShadowMap implements IFBO {
	...
	public void init(int width, int height, int internalFormat, int format, int type) {
		...
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_COMPARE_MODE, GL_COMPARE_REF_TO_TEXTURE); // GL_COMPARE_R_TO_TEXTURE
