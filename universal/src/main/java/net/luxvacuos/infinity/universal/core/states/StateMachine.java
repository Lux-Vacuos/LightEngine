...
package net.luxvacuos.infinity.universal.core.states;
...
public final class StateMachine {
	...
	public static boolean update(AbstractInfinity voxel, float deltaTime) {
	...
	public static boolean render(AbstractInfinity voxel, float alpha) {
