package net.guerra24.infinity.client.sound.soundsystem;
...
public class SoundSystemConfig {
	 ...
	 * overridding the {@link SoundSystemLogger SoundSystemLogger} class and
	 * calling the setLogger() method (must be done BEFORE instantiating the
	 * SoundSystem class!)
	 */
	 ...
	 * {@link SoundSystemLogger SoundSystemLogger} class should be extended and
	 * methods overriden to change how messages are handled. Then, the
	 * overridden class should be instantiated, and a call made to
