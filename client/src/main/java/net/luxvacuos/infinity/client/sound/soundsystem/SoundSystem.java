package net.luxvacuos.infinity.client.sound.soundsystem;
...
public class SoundSystem {
	...
	public SoundSystem() {
		...
		LinkedList<Class<Library>> libraries = SoundSystemConfig.getLibraries();

		if (libraries != null) {
			ListIterator<Class<Library>> i = libraries.listIterator();
			Class<Library> c;
			while (i.hasNext()) {
				c =  i.next();
				try {
	 ...
	 *            library.
	 */
	public SoundSystem(Class<Library> libraryClass) throws SoundSystemException {
		// create the message logger:
		logger = SoundSystemConfig.getLogger();
		// if the user didn't create one, then do it now:
		if (logger == null) {
	 ...
	 */
	protected void init(Class<Library> libraryClass) throws SoundSystemException {
		message("", 0);
	 ...
	 *            library.
	 */
	public boolean newLibrary(Class<Library> libraryClass) throws SoundSystemException {
		initialized(SET, false);
