...
package net.luxvacuos.infinity.client.rendering.api.opengl.shaders;
...
import net.luxvacuos.infinity.client.rendering.api.opengl.shaders.data.Attribute;
import net.luxvacuos.infinity.client.rendering.api.opengl.shaders.data.UniformBoolean;
import net.luxvacuos.infinity.client.rendering.api.opengl.shaders.data.UniformFloat;
import net.luxvacuos.infinity.client.rendering.api.opengl.shaders.data.UniformInteger;
import net.luxvacuos.infinity.client.rendering.api.opengl.shaders.data.UniformMatrix;
import net.luxvacuos.infinity.client.rendering.api.opengl.shaders.data.UniformSampler;
import net.luxvacuos.infinity.client.rendering.api.opengl.shaders.data.UniformVec2;
import net.luxvacuos.infinity.client.rendering.api.opengl.shaders.data.UniformVec3;
