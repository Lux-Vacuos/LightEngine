...
package net.luxvacuos.infinity.client.input;

import org.lwjgl.glfw.GLFW;

import net.luxvacuos.infinity.client.input.callbacks.KeyboardCharCallback;
import net.luxvacuos.infinity.client.input.callbacks.KeyboardCharModsCallback;
import net.luxvacuos.infinity.client.input.callbacks.KeyboardKeyCallback;
