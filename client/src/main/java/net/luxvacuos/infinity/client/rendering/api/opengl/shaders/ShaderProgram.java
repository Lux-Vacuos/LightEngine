...
import net.luxvacuos.infinity.client.core.exception.CompileShaderException;
import net.luxvacuos.infinity.client.core.exception.LoadShaderException;
import net.luxvacuos.infinity.client.rendering.api.opengl.shaders.data.Attribute;
import net.luxvacuos.infinity.client.rendering.api.opengl.shaders.data.IUniform;
