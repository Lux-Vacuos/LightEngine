package net.luxvacuos.infinity.client.sound.soundsystem.codecs;
...
import net.luxvacuos.infinity.client.sound.soundsystem.SoundSystemLogger;
	...
	public boolean initialize(URL url) {
		...
		try {
			...
			myAudioFormat = new AudioFormat(AudioFormat.Encoding.PCM_SIGNED,
					(float) myIdentificationHeader.getSampleRate(), 16, myIdentificationHeader.getChannels(),
					myIdentificationHeader.getChannels() * 2, (float) myIdentificationHeader.getSampleRate(), true);
