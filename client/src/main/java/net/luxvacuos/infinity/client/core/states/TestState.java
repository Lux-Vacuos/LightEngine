...
import net.luxvacuos.infinity.client.core.ClientWorldSimulation;
import net.luxvacuos.infinity.client.core.CoreInfo;
import net.luxvacuos.infinity.client.input.KeyboardHandler;
import net.luxvacuos.infinity.client.rendering.api.glfw.Window;
import net.luxvacuos.infinity.client.rendering.api.glfw.WindowManager;
import net.luxvacuos.infinity.client.rendering.api.nanovg.Timers;
import net.luxvacuos.infinity.client.rendering.api.nanovg.UIRendering;
import net.luxvacuos.infinity.client.rendering.api.opengl.ParticleDomain;
...
import net.luxvacuos.infinity.client.rendering.api.opengl.objects.Material;
import net.luxvacuos.infinity.client.rendering.api.opengl.objects.ParticleTexture;
import net.luxvacuos.infinity.client.rendering.api.opengl.objects.RawModel;
import net.luxvacuos.infinity.client.rendering.api.opengl.objects.Texture;
import net.luxvacuos.infinity.client.rendering.api.opengl.objects.TexturedModel;
import net.luxvacuos.infinity.client.resources.ResourceLoader;
import net.luxvacuos.infinity.client.util.Maths;
import net.luxvacuos.infinity.client.world.entities.BasicEntity;
import net.luxvacuos.infinity.client.world.entities.Camera;
import net.luxvacuos.infinity.client.world.entities.EntityResources;
import net.luxvacuos.infinity.client.world.entities.PlayerCamera;
import net.luxvacuos.infinity.client.world.entities.Sun;
import net.luxvacuos.infinity.client.world.particles.ParticleSystem;
import net.luxvacuos.infinity.universal.core.AbstractInfinity;
import net.luxvacuos.infinity.universal.core.states.AbstractState;
import net.luxvacuos.infinity.universal.core.states.StateMachine;
import net.luxvacuos.infinity.universal.ecs.components.AABB;
...
import net.luxvacuos.infinity.universal.ecs.components.Velocity;
import net.luxvacuos.infinity.universal.world.PhysicsSystem;
...
public class TestState extends AbstractState {
	...
	private BasicEntity mat1, mat2, mat3, mat4, mat5, rocket, plane, character, suzane;
	...
	public void init() {
		...
		worldSimulation = new ClientWorldSimulation(6000);
		engine = new Engine();
		...
		character.getComponent(Position.class).set(0, 20, 5);
		character.getComponent(Scale.class).setScale(0.21f);
		character.add(new AABB(new Vector3d(-0.25, 0, -0.25), new Vector3d(0.25, 1, 0.25)));
		character.add(new Velocity());
		...
		suzane = new BasicEntity(new TexturedModel(loader.loadObjModel("test_state/suzane"),
				new Material(new Vector4f(1), 1, 0, null, null, null, null)));
		suzane.getComponent(Position.class).set(0, 0, 7);
		suzane.getComponent(Scale.class).setScale(0.4f);
	}
	...
	public void start() {
		...
		physicsSystem.getEngine().addEntity(suzane);
	...
	public void render(AbstractInfinity voxel, float alpha) {
		...
		if (ClientVariables.debug) {
			UIRendering.renderText(window.getID(), "Infinity " + " (" + ClientVariables.version + ")", "Roboto-Bold", 5,
