...
import net.luxvacuos.infinity.client.ui.UIPanel;
import net.luxvacuos.infinity.client.ui.UIParagraph;
...
public class CrashState extends AbstractState {
	...
	public void init() {
		...
		title = new UIText("Infinity", 0, h);
		title.setColor(0, 125, 255, 255);
		title.setAlign(NVG_ALIGN_CENTER | NVG_ALIGN_MIDDLE);
		title.setFont("Px437_IBM_VGA8");

		line1 = new UIText("An error has ocurred and unfortunately Infinity is unable to", -370, 75);
	...
	@Override
	public void update(AbstractInfinity voxel, float deltaTime) {
