...
public class SoundSystemConfig {
	 ...
	 */
	private static LinkedList<Class<Library>> libraries;
	...
	public static void addLibrary(Class<?> libraryClass) throws SoundSystemException {
		...
		if (libraries == null)
			libraries = new LinkedList<Class<Library>>();

		if (!libraries.contains(libraryClass))
			libraries.add((Class<Library>) libraryClass);
	}
	 ...
	 *         were specified.
	 */
	public static LinkedList<Class<Library>> getLibraries() {
		return libraries;
	}
