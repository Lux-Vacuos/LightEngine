...
package net.luxvacuos.infinity.client.rendering.api.glfw;
...
import net.luxvacuos.infinity.client.core.exception.GLFWException;
...
public final class WindowManager {
	...
	public static long createWindow(WindowHandle handle, boolean vsync) {
		...
		if (handle.cursor != null) {
			...
			try {
				System.out.println( ClientVariables.assets );
