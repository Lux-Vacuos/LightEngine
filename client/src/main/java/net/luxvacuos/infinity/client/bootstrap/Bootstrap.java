...
package net.luxvacuos.infinity.client.bootstrap;

import net.luxvacuos.infinity.client.core.ClientVariables;
import net.luxvacuos.infinity.client.core.Infinity;
...
public class Bootstrap extends AbstractBootstrap {
	...
	@Override
	public void init() {
		Thread.currentThread().setName("Infinity-Client");
	}
	...
	public static void main(String[] args) {
		new Infinity(new Bootstrap(args));
	}
