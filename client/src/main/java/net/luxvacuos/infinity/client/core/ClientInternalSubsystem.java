...
package net.luxvacuos.infinity.client.core;

import java.io.File;

import net.luxvacuos.infinity.client.rendering.api.glfw.Icon;
import net.luxvacuos.infinity.client.rendering.api.glfw.PixelBufferHandle;
import net.luxvacuos.infinity.client.rendering.api.glfw.Window;
import net.luxvacuos.infinity.client.rendering.api.glfw.WindowHandle;
...
import net.luxvacuos.infinity.client.rendering.api.opengl.shaders.ShaderIncludes;
import net.luxvacuos.infinity.client.rendering.api.opengl.shaders.TessellatorBasicShader;
import net.luxvacuos.infinity.client.rendering.api.opengl.shaders.TessellatorShader;
import net.luxvacuos.infinity.client.resources.ResourceLoader;
import net.luxvacuos.infinity.client.sound.LibraryLWJGLOpenAL;
import net.luxvacuos.infinity.client.sound.soundsystem.SoundSystem;
import net.luxvacuos.infinity.client.sound.soundsystem.SoundSystemConfig;
import net.luxvacuos.infinity.client.sound.soundsystem.SoundSystemException;
import net.luxvacuos.infinity.client.sound.soundsystem.codecs.CodecJOgg;
import net.luxvacuos.infinity.client.util.LoggerSoundSystem;
import net.luxvacuos.infinity.universal.core.AbstractInternalSubsystem;
import net.luxvacuos.infinity.universal.core.TaskManager;
...
public class ClientInternalSubsystem extends AbstractInternalSubsystem {
	...
	public void preInit() {
		...
		WindowHandle handle = WindowManager.generateHandle(ClientVariables.WIDTH, ClientVariables.HEIGHT, "Infinity");
