...
import net.luxvacuos.infinity.client.core.states.AboutState;
import net.luxvacuos.infinity.client.core.states.CrashState;
import net.luxvacuos.infinity.client.core.states.MainMenuState;
import net.luxvacuos.infinity.client.core.states.OptionsState;
import net.luxvacuos.infinity.client.core.states.SplashScreenState;
import net.luxvacuos.infinity.client.core.states.StateNames;
import net.luxvacuos.infinity.client.core.states.TestState;
...
import net.luxvacuos.infinity.universal.bootstrap.AbstractBootstrap;
import net.luxvacuos.infinity.universal.bootstrap.Platform;
import net.luxvacuos.infinity.universal.core.AbstractInfinity;
import net.luxvacuos.infinity.universal.core.EngineType;
import net.luxvacuos.infinity.universal.core.TaskManager;
import net.luxvacuos.infinity.universal.core.states.StateMachine;
import net.luxvacuos.infinity.universal.util.PerRunLog;

/**
 * Infinity's Heart, the main object where the loop is stored.
 * 
 * @author Guerra24 <pablo230699@hotmail.com>
 * @category Kernel
 */
public class Infinity extends AbstractInfinity {
	 ...
	 */
	public Infinity(AbstractBootstrap bootstrap) {
		super(bootstrap);
	...
	public void preInit() throws Exception {
		...
		Logger.log("Infinity Client Version: " + ClientVariables.version);
