...
import static net.luxvacuos.infinity.client.input.Mouse.getDX;
import static net.luxvacuos.infinity.client.input.Mouse.getDY;
import static net.luxvacuos.infinity.client.input.Mouse.setCursorPosition;
import static net.luxvacuos.infinity.client.input.Mouse.setGrabbed;
...
import net.luxvacuos.infinity.universal.core.GlobalVariables;
import net.luxvacuos.infinity.universal.ecs.Components;
import net.luxvacuos.infinity.universal.ecs.components.AABB;
import net.luxvacuos.infinity.universal.ecs.components.ChunkLoader;
import net.luxvacuos.infinity.universal.ecs.components.Health;
